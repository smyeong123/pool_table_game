 ...
 */
public class Ball implements Drawable, Movable, Prototype {
    ...
    public Ball(Color colour, double xPos, double yPos, double xVel, double yVel, double mass, BallType type, BallPocketStrategy pocketAction) throws IllegalArgumentException {
        this.shape = new Circle(this.originalPos[0], this.originalPos[1], RADIUS);
        this.mouseDragLine = new Line();
        this.mouseDragLine.setVisible(false);
        this.colour = colour;
    ...
    public void setFallCounter(int fallCounter) {this.fallCounter = fallCounter;}
    public void setDisabled(boolean isDisabled) {this.disabled = isDisabled;}

    /**
     * Deep copy the Ball object
     */
    public Object clone() {
        Ball cloneObject = new Ball(this.getColour(), this.getXPos(), this.getYPos(), this.getXVel(), this.getYVel(), this.getMass(), this.getBallType(), this.getPocketAction());
        cloneObject.setInitialXPos(this.originalPos[0]);
        cloneObject.setInitialYPos(this.originalPos[1]);
        cloneObject.setInitialXVel(this.originalVel[0]);
        cloneObject.setInitialYVel(this.originalVel[1]);

        cloneObject.setXPos(this.getXPos());
        cloneObject.setYPos(this.getYPos());
        cloneObject.setXVel(this.getXVel());
        cloneObject.setYVel(this.getYVel());
        cloneObject.disabled = this.getDisable();
        cloneObject.fallCounter = this.fallCounter;
        return cloneObject;
    }
     ...
     *
     */
    public boolean getDisable() {return this.disabled;}
